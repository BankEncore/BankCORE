...
> **Implementation note:** The current app uses a single `bankcore` theme in [app/javascript/daisyui.theme.js](../../../../app/javascript/daisyui.theme.js). This doc describes an optional `bankcore-light` / `bankcore-dark` variant you can adopt.
