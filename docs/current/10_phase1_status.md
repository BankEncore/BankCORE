...
**As of:** 2026-03-01  
**Scope authority:** [10_phase1_spec.md](10_phase1_spec.md)  
...
- [x] Reverse transaction (request + receipt via shared receipt viewer)
...
- **Posting decomposition:** Define an incremental refactor specification to split posting responsibilities while preserving behavior.
  - **Spec:** [30_posting_refactor_spec.md](../../planned/30_posting_refactor_spec.md)
