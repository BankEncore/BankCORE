...
- **[00_stimulus_event_matrix_handoff.md](00_stimulus_event_matrix_handoff.md)** — Stimulus event contract: who emits/consumes, payloads, guards, state transitions, migration phases (PR1–PR6).
...
2. **Events** → [00_stimulus_event_matrix_handoff.md](00_stimulus_event_matrix_handoff.md)
