class TellerTransaction < ApplicationRecord
  ...
  TRANSACTION_TYPES = %w[deposit withdrawal transfer vault_transfer draft check_cashing misc_receipt bill_payment session_close_variance session_handoff_variance reversal].freeze
