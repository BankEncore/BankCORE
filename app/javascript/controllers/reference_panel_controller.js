...
export default class extends Controller {
  ...
  findAllPostingTargets(targetName) {
    const prefixes = ["posting-form", "deposit-form", "withdrawal-form", "transfer-form", "check-cashing-form", "draft-form", "misc-receipt-form", "bill-payment-form", "vault-transfer-form"]
    const found = new Set()
