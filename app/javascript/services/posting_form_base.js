...
export default class extends Controller {
  ...
  async submit(event) {
    ...
    const hasApprovalToken = this.hasApprovalTokenTarget && this.approvalTokenTarget.value
    let submittedRequestId
    if (hasApprovalToken && ridInput?.value) {
      submittedRequestId = ridInput.value
    } else {
      submittedRequestId = this.generateRequestId()
