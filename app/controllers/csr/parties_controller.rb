  ...
  class PartiesController < BaseController
    ...
    def create
      ...
      if @party.save
        begin
          create_party_detail
          redirect_to csr_party_path(@party), notice: "Party created."
    ...
    def update
      if @party.update(party_params)
        update_party_detail
        redirect_to csr_party_path(@party), notice: "Party updated."
      else
    ...
    private
      ...
      def ensure_authorized
        authorize([ :csr, @party || Party ], policy_class: Csr::PartyPolicy)
      end
