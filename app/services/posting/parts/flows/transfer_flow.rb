  ...
  module Parts
    module Flows
      class TransferFlow < BaseFlow
        def initialize(amount_cents:, fee_cents:, primary_account_reference:, counterparty_account_reference:, fee_income_account_reference: nil)
          @amount_cents = amount_cents.to_i
          @fee_cents = fee_cents.to_i
          @primary_account_reference = primary_account_reference.to_s.strip
          @counterparty_account_reference = counterparty_account_reference.to_s.strip
          @fee_income_account_reference = fee_income_account_reference.to_s.strip.presence || "income:transfer_fee"
        end
        ...
        attr_reader :amount_cents, :fee_cents, :primary_account_reference, :counterparty_account_reference, :fee_income_account_reference
        ...
        def raw_legs
          legs = [
            ...
            { side: "credit", account_reference: counterparty_account_reference, amount_cents: cac_total }
          ]
